...
\label{sec:3_AlgoritmoGeneticoRegimePermanente}
...
\begin{algorithm}[H]
  \floatname{algorithm}{Pseudocódigo}
  \caption{Algoritmo Genético Regime Permanente com Contador de Ocorrências}
  \label{alg:agrpm2}
  \begin{algorithmic}
    \State Inicialize a população $P$ com $T$ soluções geradas aleatoriamente;
    \State Avalie as $N$ soluções da população $P$;
